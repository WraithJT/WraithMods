        ...
        static class BlueprintsCache_Init_patch
        {
            ...
            static void PatchJudgments()
            {
                ...
                string[] judgmentGUIDs = new string[] {
                    ...
                    "15d3b21354c105b498a0b1b293280ded",
                    "00b6d36e31548dc4ab0ac9d15e64a980",
                    "487af80cdfbaad74b8c2fd644c538233",
                    "1bb08308c9f6a5e4697887cd438b7221",
                    "ad61fc9dec7822b45891c78c9da5d5da",
                    "4ebaf39efb8ffb64baf92784808dc49c",
                    "d7e61eb9f0cec5e49bd1b0c428fa98e4",
                    "72fe16312b4479145afc6cc6c87cd08f",
                    "2c448ab4135c7c741b6f0f223901f9fa",
                    "3bb25de520e78744ea3ac406b918ab3e",
                    "1f7e326d3a88fd84985a60e416388c27",
                    "d47ecfecae485ac41b54fe4e8027797c",
                    "1452fb3e0e3e2f6488bee09050097b6f",
                    "bfec9cee57e7a7d47a8641c5c9d43c41"
                };

                foreach (string s in judgmentGUIDs)
                {
                    UpdateJudgment(s);
                }
            ...
            {
                var judgmentAbility = ResourcesLibrary.TryGetBlueprint<BlueprintActivatableAbility>(judgmentAbilityGUID);
                judgmentAbility.OnlyInCombat = false;
                judgmentAbility.DeactivateIfCombatEnded = false;
                judgmentAbility.DeactivateImmediately = true;
                judgmentAbility.ActivationType = AbilityActivationType.Immediately;
            }
        }
    }
}
